...
def test_water_column_height():
    ...
    # Additional tests
    assert water_column_height(10.0,5.0) == 13.75
    assert water_column_height(100.0,20.0) == 115.0
...
def test_pressure_loss_from_pipe_reduction():
    ...
    # Additional tests
    assert pressure_loss_from_pipe_reduction(0.28687,1.00,300000,0.48692) == approx(-60.000, abs=0.001)
    assert pressure_loss_from_pipe_reduction(0.28687,2.00,600000,0.48692) == approx(-250.000, abs=0.01)

# Call the main function that is part of pytest
if __name__ == "__main__":
    pytest.main(["-v", "--tb=line", "-rN"]) # type: ignore